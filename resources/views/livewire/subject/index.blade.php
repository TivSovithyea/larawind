            ...
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Short Name</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    @foreach ($data as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">{{ $item->short_name }}</td>
                            <td class="px-6 py-4">
            ...
            <div class="flex flex-col justify-center">
                ...
                <div class='w-full md:w-1/2 px-3 mb-6'>
                    ...
                    <input wire:model='short_name'
                        class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                        id='grid-text-1' type='text' placeholder='short name' name="short name" required>
                </div>
                <div class='w-full md:w-1/2 px-3 mb-6'>
