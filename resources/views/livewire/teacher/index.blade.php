                ...
                <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 font-medium text-gray-900">Name Latin</th>
                            <th scope="col" class="px-6 py-4 font-medium text-gray-900">Gender</th>
                            <th scope="col" class="px-6 py-4 font-medium text-gray-900">Date of Birth</th>
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <div class='w-full md:w-1/2 px-3 mb-6'>
                        ...
                        <input wire:model='code'
                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                            id='grid-text-1' type='text' placeholder='code' name="code" required>
                    </div>
                    <div class='w-full md:w-1/2 px-3 mb-6'>
                        <label>Name</label>
                    ...
                    <div class='w-full md:w-1/2 px-3 mb-6'>
                        ...
                        <input wire:model='name_latin'
                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                            id='grid-text-1' type='text' placeholder='name_latin' name="name_latin" required>
                    </div>
                    <div class='w-full md:w-1/2 px-3 mb-6'>
                        <label>Gender</label>
                        <select wire:model='gender'
                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                            id='grid-text-1' type='text' placeholder='gender' name="gender">
                    ...
                    <div class='w-full md:w-1/2 px-3 mb-6'>
                        ...
                        <input wire:model='dob'
                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                            id='grid-text-1' type='date' placeholder='dob' name="dob" required>
                    </div>
                    <div class='w-full md:w-1/2 px-3 mb-6'>
                        <label>Phone</label>
                        <input wire:model='phone'
                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                            id='grid-text-1' type='text' placeholder='phone' name="phone" required>
                    </div>
                    <div class='w-full md:w-1/2 px-3 mb-6'>
                        <label>Address</label>
                        <input wire:model='address'
                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                            id='grid-text-1' type='text' placeholder='address' name="address" required>
                    </div>
                    <div class='w-full md:w-1/2 px-3 mb-6'>
                        <label>Subject</label>
                        <select wire:model='teacher_subjects'
                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                            id='grid-text-1' type='text' placeholder='subject' name="subject" multiple>
